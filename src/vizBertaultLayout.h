...
class OGDF_EXPORT VizBertaultLayout : public LayoutModule
{
public:
	...
	VizBertaultLayout(double length, int number);	// length= desired edge length... number= number of iterations

	//! Constructor, with user defined values for number of iterations.
	explicit VizBertaultLayout(int number);	// number= number of iterations
