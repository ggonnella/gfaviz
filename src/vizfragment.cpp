...
void VizFragment::setHighlight(bool _val) {
...
VizFragmentGraphicsItem::VizFragmentGraphicsItem(VizFragment* _parent) : VizElementGraphicsItem(_parent) {
...
void VizFragmentGraphicsItem::setHighlight(bool val) {
  if (val) {
    QPen pen(Qt::black);
    pen.setWidth(2);
