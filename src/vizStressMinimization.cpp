...
const double VizStressMinimization::EPSILON = 10e-4;

const int VizStressMinimization::DEFAULT_NUMBER_OF_PIVOTS = 50;


void VizStressMinimization::call(GraphAttributes& GA)
{
...
void VizStressMinimization::call(
	GraphAttributes& GA,
...
void VizStressMinimization::computeInitialLayout(GraphAttributes& GA)
{
...
void VizStressMinimization::replaceInfinityDistances(
	NodeArray<NodeArray<double> >& shortestPathMatrix,
	double newVal)
{
...
void VizStressMinimization::calcWeights(
	const Graph& G,
	NodeArray<NodeArray<double> >& shortestPathMatrix,
	NodeArray<NodeArray<double> >& weightMatrix)
{
...
double VizStressMinimization::calcStress(
...
void VizStressMinimization::copyLayout(
	const GraphAttributes& GA,
...
void VizStressMinimization::minimizeStress(
	GraphAttributes& GA,
	NodeArray<NodeArray<double> >& shortestPathMatrix,
	NodeArray<NodeArray<double> >& weightMatrix)
{
...
void VizStressMinimization::nextIteration(
	GraphAttributes& GA,
	NodeArray<NodeArray<double> >& shortestPathMatrix,
...
bool VizStressMinimization::finished(
	GraphAttributes& GA,
...
void VizStressMinimization::initMatrices(const Graph& G,
	NodeArray<NodeArray<double> >& shortestPathMatrix,
	NodeArray<NodeArray<double> >& weightMatrix)
{
