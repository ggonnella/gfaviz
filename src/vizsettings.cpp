...
void VizGraphSettings::initParams() {
  ...
  params[VIZ_FRAGMENTWEIGHT] = VizGraphParamAttrib("fragment-weight", "Weight factor in the computation of fragment lengths.", QMetaType::Double, VIZ_NONE, QVariant(7.0f));
  params[VIZ_FRAGMENTMINWEIGHT] = VizGraphParamAttrib("fragment-minweight", "Min weight factor in the computation of fragment lengths.", QMetaType::Double, VIZ_NONE, QVariant(1.0f));
